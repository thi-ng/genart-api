...
export interface GenArtAPI {
     ...
     * @param params
     */
    setParams<P extends ParamSpecs>(params: P): Promise<(<K extends keyof P>(id: K, opt?: number | RandomFn) => ParamValue<P[K]>)>;
    /**
     ...
     * @param timeOrRnd
     */
    getParamValue<T extends ParamSpecs, K extends keyof T>(id: K, timeOrRnd?: number | RandomFn): ParamValue<T[K]>;
    /**
     ...
     * @param opt
     */
    paramValueGetter<T extends ParamSpecs, K extends keyof T>(id: K): (opt?: number | RandomFn) => ParamValue<T[K]>;
    /**
